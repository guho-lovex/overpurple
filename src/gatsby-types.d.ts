...
type BioQueryQuery = { readonly site: { readonly pathPrefix: string | null, readonly siteMetadata: { readonly title: string | null, readonly siteUrl: string | null, readonly author: { readonly name: string | null, readonly summary: string | null } | null, readonly social: { readonly twitter: string | null } | null } | null } | null };
